                    ...
                    <ul class="nav navbar-nav ml-auto navbar-right">
                        <li class="dropdown no-arrow nav-item"><a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                            ...
                            <ul
                                ...
                                <li class="dropdown-item"><a href="<?php echo 'owner_profile.php?id='.$_SESSION['owner-id'].'&nom='.$_SESSION['owner-name'].'&prenom='.$_SESSION['owner-prenom'].'&phone='.$_SESSION['owner-phone'].'&bio='.$_SESSION['owner-bio'].'&email='.$_SESSION['owner-email']; ?>"><i class=" icon-user "></i> Profile </a>
                                </li>
                            </ul>
                        </li>
                        <li class="postadd nav-item"><a style="width: 100%;" id="rent" class="btn btn-block   btn-border btn-post btn-primary-dark nav-link" href="category.php">Rent an Appartment</a>
                        </li>
    ...
    <div class="main-container inner-page">
        <div class="container">
            <div class="section-content">
                ...
                <div  class="container">
                    <div id="owner_pub" style="background-color: #CEF6F5;" class="section-content">
...
<script type="text/javascript">
   ...
   function deletePub(x){
        //create XMLHttpRequest()
          ...
          //open the request
          xhttpp.open("GET","deletePub.php?id_h="+x,true);
          //send the request
          xhttpp.send();
     ...
     function showProfile(){
      ...
      xhttp1.onreadystatechange= function() {
        //if the request opened successfully
        if(this.readyState == 4 && this.status == 200){
           $("#owner_info").html(this.responseText);
        }
      }

      //open the request
      xhttp1.open("GET","owner_info.php?id="+<?php echo $_SESSION['owner-id'];?>,true);
      //send the request
      xhttp1.send();
...
function showPubs()
{
  ...
  xhttp.onreadystatechange= function() {
    //if the request opened successfully
    if(this.readyState == 4 && this.status == 200){
       $("#owner_pub").html(this.responseText);
    }
  }

  //open the request
  xhttp.open("GET","owner_pub.php?id="+<?php echo $_SESSION['owner-id'];?>,true);
  //send the request
  xhttp.send();
...
function updateOwner(){
  ...
  //open the request
  xhttp.open("GET","editOwner.php?id_ow="+<?php echo $_SESSION['owner-id'];?>+"&p="+prenom+"&nom="+nom+"&phone="+phone+"&bio="+bio,true);
  //send the request
  xhttp.send();
...
function updatePub(id){
  ...
  //open the request
  xhttp.open("GET","editPub.php?id_pub="+id+"&c="+category+"&t="+title+"&d="+describe+"&p="+price,true);
  //send the request
  xhttp.send();
