...
<body>
    ...
    <?php include("Controllers/House.php") ?>
                ...
                <div class="col-md-9 page-content col-thin-right">
                    <div class="inner inner-box ads-details-wrapper">
                        ...
                        <div class="ads-image">
                            ...
                            <ul  class="bxslider">
                                <li style="height: auto;"><img src="../assets/images/<?php echo $tab[0]; ?>" alt="img"/></li>
                                <li style="height: auto;"><img src="../assets/images/<?php echo $tab[1]; ?>" alt="img"/></li>
                                <li style="height: auto;"><img src="../assets/images/<?php echo $tab[2]; ?>" alt="img"/></li>
                                <li style="height: auto;"><img src="../assets/images/<?php echo $tab[3]; ?>" alt="img"/></li>
                                <li style="height: auto;"><img src="../assets/images/<?php echo $tab[4]; ?>" alt="img"/></li>
                            </ul>
                            <div id="bx-pager">
                                <a class="thumb-item-link" data-slide-index="0" href=""><img
                                        src="../assets/images/<?php echo $tab[0]; ?>" alt="img"/></a>
                                <a class="thumb-item-link" data-slide-index="1" href=""><img
                                        src="../assets/images/<?php echo $tab[1]; ?>" alt="img"/></a>
                                <a class="thumb-item-link" data-slide-index="2" href=""><img
                                        src="../assets/images/<?php echo $tab[2]; ?>" alt="img"/></a>
                                <a class="thumb-item-link" data-slide-index="3" href=""><img
                                        src="../assets/images/<?php echo $tab[3]; ?>" alt="img"/></a>
                                <a class="thumb-item-link" data-slide-index="4" href=""><img
                                        src="../assets/images/<?php echo $tab[4]; ?>" alt="img"/></a>
                            </div>
                        </div>
                        <!--ads-image-->
