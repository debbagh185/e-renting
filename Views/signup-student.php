                                ...
                                <form id="f" class="form-horizontal">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
												<input onclick="add_student()" type="button" value="Sign in" class="btn btn-primary">
											</div>
                                            <div class="col-md-4">
                                            </div>
                                        </div>
...
function add_student()
{
    ...
    if(fname && lname && phone && bio && email && pass){
          ...
          //open the request
          xhttp.open("GET","../Controllers/add-student.php?fname="+fname+"&lname="+lname+"&phone="+phone+"&bio="+bio+"&email="+email+"&pass="+pass,true);
          //send the request
          xhttp.send();
        }
}
