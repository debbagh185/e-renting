                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav ml-auto navbar-right">
                        <li class="dropdown no-arrow nav-item"><a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                            ...
                            <span><b><?php echo $_SESSION['owner-name']; ?></b></span> <i class="icon-user fa"></i> <i class=" icon-down-open-big fa"></i></a>
                            <ul
                                    class="dropdown-menu user-menu dropdown-menu-right">
                                <li class="dropdown-item"><a href="logout-owner.php"><i class=" icon-logout "></i> Log out </a>
                                </li>
                                <li class="dropdown-item"><a href="<?php echo 'owner_profile.php'; ?>"><i class=" icon-user "></i> Profile </a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="row">
                <div class="col-md-9 page-content">
                    <div class="inner-box category-content">
                        <h2 class="title-2 uppercase"><strong> <i class="icon-docs"></i> Post a Free
                            Add</strong></h2>
                            ...
                            <div class="col-sm-12">
                                ...
                                <form class="form-horizontal" method="POST" action="owner-post.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="title" type="text" class="form-control" id="Adtitle" placeholder="Ad title" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="Addescribe" rows="3">Describe what makes your ad unique</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input name="price" type="tel" class="form-control" required="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="mb10">
                                                <input name="input-upload-img1" id="input-upload-img1" type="file" class="file" data-preview-file-type="text" >
                                            </div>
                                            <div class="mb10">
                                                <input name="input-upload-img2" id="input-upload-img2" type="file" class="file" data-preview-file-type="text" >
                                            </div>
                                            <div class="mb10">
                                                <input name="input-upload-img3" id="input-upload-img3" type="file" class="file" data-preview-file-type="text" >
                                            </div>
                                            <div class="mb10">
                                                <input name="input-upload-img4" id="input-upload-img4" type="file" class="file" data-preview-file-type="text" >
                                            </div>
                                            <div class="mb10">
                                                <input name="input-upload-img5" id="input-upload-img5" type="file" class="file" data-preview-file-type="text" >
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8"><input id="button1id" type="submit" name="submit" value="Submit" 
