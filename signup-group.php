...
function post()
{
  ...
  //open the request
  xhttp.open("GET","add-group.php?name="+name+"&pass="+pass+"&nbr="+nbr,true);
  //send the request
  xhttp.send();
...
function add_std()
{
  ...
  //open the request
  xhttp.open("GET","add-student.php?fname_std="+fname_std+"&lname_std="+lname_std+"&email_std="+email_std+"&grp_name="+grp_name+"&nbr="+nmbr,true);
  //send the request
  xhttp.send();
...
function send_mails()
{
  ...
  //open the request
  xhttp.open("GET","send.php?name="+name,true);
  //send the request
  xhttp.send();
}
</script>
